...
void GatewayServerMode()
{
  ...
  mqttClient.setKeepAlive(20).setCleanSession(false).setWill("dev/data", 0, true, "no").setCredentials("json+device", "7ef7949fb37c454aa3087f63c276573d").setClientId("smartDisplayErwann");
